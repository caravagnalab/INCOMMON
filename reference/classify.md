...
#> 
#> Warning in '/tmp/RtmpnCguMB/model-1ccb575b2228.stan', line 30, column 18 to column 33:
#>     Found int division:
#>         k_max * (k_max + 1) / 2
...
#> Warning in '/tmp/RtmpnCguMB/model-1ccb575b2228.stan', line 34, column 19 to column 34:
#>     Found int division:
#>         k_max * (k_max + 1) / 2
#>     Values will be rounded towards zero. If rounding is not desired you can
#>     write the division as
#>         k_max * (k_max + 1) / 2.0
#>     If rounding is intended please use the integer division operator %/%.
#> Warning in '/tmp/RtmpnCguMB/model-1ccb575b2228.stan', line 51, column 11 to column 26:
#>     Found int division:
#>         k_max * (k_max + 1) / 2
#>     Values will be rounded towards zero. If rounding is not desired you can
#>     write the division as
#>         k_max * (k_max + 1) / 2.0
#>     If rounding is intended please use the integer division operator %/%.
#> Warning in '/tmp/RtmpnCguMB/model-1ccb575b2228.stan', line 65, column 18 to column 33:
#>     Found int division:
#>         k_max * (k_max + 1) / 2
#>     Values will be rounded towards zero. If rounding is not desired you can
#>     write the division as
#>         k_max * (k_max + 1) / 2.0
#>     If rounding is intended please use the integer division operator %/%.
#> Warning in '/tmp/RtmpnCguMB/model-1ccb575b2228.stan', line 67, column 18 to column 33:
#>     Found int division:
#>         k_max * (k_max + 1) / 2
#>     Values will be rounded towards zero. If rounding is not desired you can
#>     write the division as
#>         k_max * (k_max + 1) / 2.0
#>     If rounding is intended please use the integer division operator %/%.
#> Warning in '/tmp/RtmpnCguMB/model-1ccb575b2228.stan', line 84, column 11 to column 26:
#>     Found int division:
#>         k_max * (k_max + 1) / 2
#>     Values will be rounded towards zero. If rounding is not desired you can
#>     write the di
...
#> Chain 1 Exception: gamma_lpdf: Random variable is inf, but must be positive finite! (in '/tmp/RtmpnCguMB/model-1ccb575b2228.stan', line 43, column 2 to column 29)
