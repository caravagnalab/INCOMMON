...
Get the posterior distribution over (k,m) configurations for a specific
mutation
...
- id:
  ...
  The id of the mutation (sample:chr:from:to:ref:alt:NV:DP)

## Value

A table with the estimated posterior distribution.
