...
x = classify(x = x, 
             ...
             rho = 0.01)
```
There are 2 heterozygous mutant diploid (HMD) genes and 2 mutant genes with loss of heterozygosty (LOH). The average entropy is quite good, and the classifcation with the largest uncertainty
has still a reasonable entropy of 0.07.

```{r}
print(x)
```

The two HMD genes are KRAS and SMARCA4, whereas TP53 and STK11 are in LOH.
