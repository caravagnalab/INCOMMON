...
tumor-only read count data. Mutations are classified as either Tier-1
(present in 100% of cells) without copy-number alterations (heterozygous
mutant diploid), with loss of heterozygosity, copy-neutral loss of
heterozygosity, amplification, or Tier-2 (subclonal or with high ploidy and
low multiplicity), providing a fast genome-interpretation framework for
