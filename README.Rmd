...
clinical targeted sequencing data, without requiring matched normal
samples. This information is used to derive gene mutant dosage, an
emergent property of the interplay between somatic mutations and
copy-number alterations that is overlooked by standard binary
mutant/wild-type models. INCOMMON stratifies patients by mutant dosage of
oncogenes and tumor suppressor genes to identify biomarkers of prognosis
and metastatic tropism.
...
If you want to run INCOMMON classification (`classify()`) yourself, you also need
[`cmdstanr`](https://mc-stan.org/cmdstanr/) and a working Stan toolchain, which are
...
Alternatively, the [INCOMMON web app](https://ncalonaci.shinyapps.io/incommon/)
(see [this vignette](https://caravagnalab.github.io/INCOMMON/articles/a6_shiny_app.html))
runs the same model in your browser, with no local Stan installation required.
