...
met_tropism = function(x, gene, tumor_type, metastic_site){
  
  stopifnot(inherits(x, 'INCOMMON'))
  stopifnot(metastic_site %in% clinical_data(x)$METASTATIC_SITE)
  ...
  if(!(gene %in% names(x$metastatic_tropism[[tumor_type]]))) x$metastatic_tropism[[tumor_type]][[gene]] = list()
  
  x$metastatic_tropism[[tumor_type]][[gene]] = fit
